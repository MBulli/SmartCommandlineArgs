========================================================================
    KONSOLENANWENDUNG: Project1-Projektübersicht
========================================================================

Diese Project1-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Project1-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Project1.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
